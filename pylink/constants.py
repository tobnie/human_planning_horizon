...
## \defgroup tracker_data_types Tracker Data Type Constants
# @{
#
STARTPARSE	=	1	
ENDPARSE	=	2	
...
## \defgroup event_type_flags Event Type Flags
# @{
...
## \defgroup event_data_flags Event Data Flags
# @{
...
EVENT_GAZERES	=	0x2000	#Has 3gaze resolution
EVENT_STATUS	=	0x1000	#Has status flags
EVENT_GAZEXY	=	0x0400	#Has 3gaze x, y 2position
EVENT_HREFXY	=	0x0200	#Has head-ref x, y 2position
EVENT_PUPILXY	=	0x0100	#Has pupil x, y 2position
...
## \defgroup key_button_values Special Key values for the tracker
# @{
...
## \defgroup tracker_mode_values Tracker Mode values
# @{
...
SAMPLE_GAZEXY    = 0x0400  # 3gaze x,y pair
SAMPLE_GAZERES   = 0x0200  # 3gaze res (x,y pixels per degree) pair
...
SAMPLE_HEADPOS   = 0x0010  # head-2position: byte tells # words
