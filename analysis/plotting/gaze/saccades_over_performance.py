...
def plot_sacc_per_subject_experience(df, directory='./imgs/saccades/'):
    fig, ax = plt.subplots()
...
def plot_sacc_per_subject_score(df, directory='./imgs/saccades/'):
...
def plot_sacc_per_trial(df, directory='./imgs/saccades/'):
    # over all subjects
...
def plot_sacc_per_difficulty(df, directory='./imgs/saccades/'):
...
def plot_sacc_per_game_status(df, directory='./imgs/saccades/'):
    # over all subjects per difficulty
...
def plot_sacc_histograms(df,  directory='./imgs/saccades/'):
    # over game outcome
    g = sns.FacetGrid(df, col="game_status", margin_titles=True)
...
# plot
plot_sacc_histograms(sacc_df, directory='./imgs/saccades/filtered_saccades/')
plot_sacc_per_game_status(sacc_df, directory='./imgs/saccades/filtered_saccades/')
plot_sacc_per_difficulty(sacc_df, directory='./imgs/saccades/filtered_saccades/')
plot_sacc_per_subject_score(sacc_df, directory='./imgs/saccades/filtered_saccades/')
plot_sacc_per_subject_experience(sacc_df, directory='./imgs/saccades/filtered_saccades/')
...
plot_sacc_per_trial(sacc_df_without_nan_trials, directory='./imgs/saccades/filtered_saccades/')
